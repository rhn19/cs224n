...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        self.stack = ["ROOT"]
        self.buffer = self.sentence.copy() #not using copy may result into modification of sentence
        self.dependencies = []
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        for par, trans in zip(parsers, transitions):
            par.parse([trans])
            if not par.buffer and len(par.stack) == 1:
