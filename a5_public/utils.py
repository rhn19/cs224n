...
def pad_sents_char(sents, char_pad_token):
    ...
    for sen in sents:
        words_padded = []
        for word in sen[:max_length]:
            word = word[:max_word_length]
            word = word + [char_pad_token for _ in range(max_word_length - len(word))]
            words_padded.append(word)
        sen = words_padded + [[char_pad_token for _ in range(max_word_length)] for _ in range(max_length - len(sen))]
...
def pad_sents(sents, pad_token):
    ...
    for sen in sents:
        sen = sen + [pad_token for _ in range(max_length - len(sen))]
        sents_padded.append(sen)
